...
\begin{titlepage}
    ...
    \includegraphics[width=0.7\textwidth]{TU_Chemnitz_Logo_gruen.svg.png} \\[0cm]
...
% ── Sub-sections ────────────────────────────────────────────────────────────
\include{section/overview}    % Part 1
\include {section/literature_review} %Part 2 (Literature review about each components)
\include{section/code_understanding}   % Part 3 (Includes and serialPrint)
\include{section/Hardware_setup}
