...
\include {literature_review} %Part 2 (Literature review about each components)
\include{code_understanding}   % Part 3 (Includes and serialPrint)
\include{Hardware_setup}
